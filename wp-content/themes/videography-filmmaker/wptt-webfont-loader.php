...
if ( ! class_exists( 'Videography_Filmmaker_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Videography_Filmmaker_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Videography_Filmmaker_WPTT_WebFont_Loader( $url );
