...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="services-box mb-5">    
    ...
    <div class="lower-box">
      ...
      <?php } ?>
      <?php if(get_theme_mod('videography_filmmaker_post_content') == 'Full Content'){ ?>
        <?php the_content(); ?>
      <?php }
      if(get_theme_mod('videography_filmmaker_post_content', 'Excerpt Content') == 'Excerpt Content'){ ?>
