...
class Videography_Filmmaker_Icon_Changer extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                        <div class="social-icon-search">
                              <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'videography-filmmaker'); ?>">
                        </div>
                        <?php
                        $videography_filmmaker_font_awesome_icon_array = videography_filmmaker_font_awesome_icon_array();
                        foreach ($videography_filmmaker_font_awesome_icon_array as $videography_filmmaker_font_awesome_icon) {
                              $icon_class = $this->value() == $videography_filmmaker_font_awesome_icon ? 'icon-active' : '';
                              echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($videography_filmmaker_font_awesome_icon).'"></i>
                                    <span class="icons-class">'.esc_attr($videography_filmmaker_font_awesome_icon).'</span>
                              </li>';
                        }
                        ?>
                  </ul>
...
function videography_filmmaker_customizer_script() {
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'videography_filmmaker_customizer_script' );

if(!function_exists('videography_filmmaker_font_awesome_icon_array')){
    function videography_filmmaker_font_awesome_icon_array(){
        return array("None", 
            "fab fa-500px",
