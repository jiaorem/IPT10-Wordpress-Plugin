<?php
	...
	$bb_mobile_application_custom_css .='.primary-navigation ul li a{';
		$bb_mobile_application_custom_css .='color: '.esc_attr($bb_mobile_application_menu_color_settings).';';
	$bb_mobile_application_custom_css .='} ';
	...
	$bb_mobile_application_custom_css .='.primary-navigation ul li a:hover {';
		$bb_mobile_application_custom_css .='color: '.esc_attr($bb_mobile_application_menu_hover_color_settings).';';
	$bb_mobile_application_custom_css .='} ';
	...
	$bb_mobile_application_custom_css .='.primary-navigation ul.sub-menu li a {';
		$bb_mobile_application_custom_css .='color: '.esc_attr($bb_mobile_application_submenu_color_settings).';';
	$bb_mobile_application_custom_css .='} ';
	...
	$bb_mobile_application_custom_css .='color: '.esc_attr($bb_mobile_application_submenu_hover_color_settings).';';
	$bb_mobile_application_custom_css .='} ';
