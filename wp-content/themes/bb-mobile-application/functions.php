...
function bb_mobile_application_scripts() {
	...
	wp_enqueue_style( 'effect-css', esc_url(get_template_directory_uri()).'/css/effect.css' );
	wp_enqueue_style('bb-mobile-application-block-pattern-frontend', esc_url(get_template_directory_uri()).'/theme-block-pattern/css/block-pattern-frontend.css');
	wp_enqueue_style( 'fontawesome-all-css', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css' );
