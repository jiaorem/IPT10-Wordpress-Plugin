...
function ts_mobile_app_enqueue_styles() {
	...
	wp_enqueue_style( 'ts-mobile-app-block-patterns-style-frontend', get_theme_file_uri('/theme-block-pattern/css/block-pattern-frontend.css') );
...
/**
	 ...
	 */
	function ts_mobile_app_block_editor_styles() {
		wp_enqueue_style( 'ts-mobile-app-font', ts_mobile_app_font_url(), array() );
	    wp_enqueue_style( 'ts-mobile-app-block-patterns-style-editor', get_theme_file_uri( '/theme-block-pattern/css/block-pattern-editor.css' ), false, '1.0', 'all' );
	}
	add_action( 'enqueue_block_editor_assets', 'ts_mobile_app_block_editor_styles' );
